...
/* =============================================================================
   ...
   ============================================================================= */
(function(){
 window.LPW_DECISION_SCORE_AUDIT_VERSION='8.6.14';
 document.querySelectorAll('.build-tag').forEach(node=>node.textContent='VERSION 8.6.14');
})();
...
/* ============================================================
   LEGACY PRO WRESTLING 8.6.6 — BRAND IDENTITY INTEGRATION
   ============================================================ */
window.LPW_BRAND_VERSION='8.6.14';
