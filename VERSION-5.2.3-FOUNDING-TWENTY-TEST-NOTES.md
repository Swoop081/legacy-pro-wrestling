...
## Image framework
Both wrestlers now have registered `full.webp`, `portrait.webp` and `victory.webp` assets. Screen-specific presets cover roster cards, partner selection, hero screens, profiles, match portraits and cinematic result screens. Dave Maddox is treated as a narrower full-body silhouette; Logan Steele is treated as a broader silhouette.
