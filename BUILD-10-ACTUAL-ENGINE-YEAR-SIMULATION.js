...
let seed=83710;function rng(){seed=(seed*1664525+1013904223)>>>0;return seed/4294967296}
let timers=[];
...
for(const f of ['data.js','game.js'])vm.runInContext(fs.readFileSync('/mnt/data/lpw_build10/'+f,'utf8'),context,{filename:f});
...
fs.writeFileSync('/mnt/data/lpw_build10/BUILD-10-ACTUAL-ENGINE-YEAR-RUN.json',JSON.stringify(sim,null,2));
